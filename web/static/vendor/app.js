...
var _user$project$Ports$ready = _elm_lang$core$Native_Platform.outgoingPort(
	'ready',
	function (v) {
		return v;
	});
...
var _user$project$Restaurants_Types$decodeRestaurantFetch = A2(
	...
	_elm_lang$core$Json_Decode$list(_user$project$Restaurants_Types$decodeRestaurantData));
var _user$project$Restaurants_Types$decodeRestaurantResponse = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'restaurant',
...
var _user$project$Restaurants_Types$Url = function (a) {
...
var _user$project$Restaurants_Types$UpdateRestaurants = function (a) {
	...
	if (_p0.ctor === 'Nothing') {
		...
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('dropdown restaurant-create form-inline'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Restaurants_View$renderRestaurantList = F2(
	function (restaurants, selection) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('list-group restaurant-list'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				function (r) {
					return A2(
						_elm_lang$html$Html$li,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_user$project$Restaurants_View$selectionClass, r, selection)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Restaurants_Types$SelectRestaurant(r)),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Restaurants_View$renderRestaurantMaster = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('restaurant-master col-md-4 col-sm-12'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _Fresheyeball$elm_font_awesome$FontAwesome_Web$minus,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _Fresheyeball$elm_font_awesome$FontAwesome_Web$plus,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					}),
				_1: _user$project$Restaurants_View$renderCreateRestaurantForm(model.newRestaurant)
			}
		});
};
var _user$project$Restaurants_View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Restaurants_View$renderRestaurantMaster(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('restaurant-detail col-md-8 col-sm-12'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Restaurants_Ports$googleMap = _elm_lang$core$Native_Platform.outgoingPort(
	'googleMap',
	function (v) {
		return v;
	});
			...
			case 'ShowRestaurant':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							restaurantList: {ctor: '::', _0: _p0._0, _1: model.restaurantList}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HideRestaurant':
...
var _user$project$App$RestaurantsMsg = function (a) {
	return {ctor: 'RestaurantsMsg', _0: a};
};
...
var _user$project$App$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p1.ctor) {
				case 'RestaurantsMsg':
					var _p2 = A2(_user$project$Restaurants_State$update, _p1._0, model.restaurants);
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{restaurants: updatedModel}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$RestaurantsMsg, cmd)
					};
				case 'NewMessage':
					var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Restaurants_Types$decodeRestaurantData, _p1._0);
					if (_p3.ctor === 'Ok') {
						var _v2 = _user$project$App$RestaurantsMsg(
							_user$project$Restaurants_Types$ShowRestaurant(_p3._0)),
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				_user$project$App$RestaurantsMsg,
				_user$project$Restaurants_View$view(model.restaurants)),
			_1: {ctor: '[]'}
		});
};
